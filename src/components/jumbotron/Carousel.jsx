        ...
        <Carousel.Item className='second-item item'>
          ...
          <div className='contenitore secondo'>
            ...
            <p>
              ...
              ricerca della Verità, il leggendario artefatto capace di invertire
              la Regressione, il male che sta progressivamente cancellando la
              memoria del genere umano.
            </p>
          </div>
        </Carousel.Item>
